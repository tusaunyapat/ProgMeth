...
public class ChangeColorCardTest {
    ...
    void testPerformEffectHasColor() {
        ...
        gameInstant.getCurrentPlayerHand().add(c2);
        BaseCard first = gameInstant.getCurrentPlayerHand().get(0);
        c1.performEffect();

        assertEquals(first.getColor(), c1.getColor());
    }
    ...
    void testPerformEffectNoColor() {
        ...
        gameInstant.getCurrentPlayerHand().add(c1);
        BaseCard first = gameInstant.getCurrentPlayerHand().get(0);
        c3.performEffect();
